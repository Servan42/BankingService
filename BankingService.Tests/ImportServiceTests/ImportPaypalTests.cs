...
namespace BankingService.Tests.ImportServiceTests
{
    internal class ImportPaypalTests
    {
        ...
        public void Should_integrate_paypal_data_to_output_for_exact_date()
        {
            ...
            {
                new OperationDto { Id = 3, Date = new DateTime(2024,01,07), Flow = -10.99m, Treasury = 0, Label = "a", Type = "Paypal", AutoComment = "Spotify AB", Category = "Loisirs", Comment = "e" }
            };
        ...
        public void Should_correctly_match_paypal_data_when_two_lines_have_the_same_date_and_flow()
        {
            ...
            var expected = new List<OperationDto>
            {
                new OperationDto { Id = 1, Date = new DateTime(2024,01,07), Flow = -10.99m, Treasury = 0, Label = "a", Type = "Paypal", AutoComment = "Spotify AB", Category = "Loisirs", Comment = "e" },
                new OperationDto { Id = 2, Date = new DateTime(2024,01,07), Flow = -10.99m, Treasury = 100, Label = "a", Type = "Paypal", AutoComment = "Spotify AB 2", Category = "Loisirs", Comment = "e" }
            };
            bankDatabaseService.Verify(x => x.UpdateOperations(It.Is<List<OperationDto>>(actual => TestHelpers.CheckOperationDtos(actual, expected))), Times.Once());
        }
        ...
        public void Should_match_unmatched_paypal_data_with_incremental_date_offset()
        {
            ...
            var expected = new List<OperationDto>
            {
                new OperationDto { Id = 2, Date = new DateTime(2024,01,25), Flow = -22.99m, Treasury = 10, Label = "aa", Type = "Paypal", AutoComment = "Steam", Category = "Loisirs2", Comment = "e" },
                new OperationDto { Id = 1, Date = new DateTime(2024,01,10), Flow = -10.99m, Treasury = 0, Label = "a", Type = "Paypal", AutoComment = "Spotify AB", Category = "Loisirs", Comment = "e" }
            };
            bankDatabaseService.Verify(x => x.UpdateOperations(It.Is<List<OperationDto>>(actual => TestHelpers.CheckOperationDtos(actual, expected))), Times.Once());
        }
    }
